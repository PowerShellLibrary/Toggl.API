...
[![Build Status](https://img.shields.io/github/actions/workflow/status/PowerShellLibrary/Toggl.API/test.yml?branch=master&logo=github&labelColor=373e45&label=Pester)](https://github.com/PowerShellLibrary/Toggl.API/actions/workflows/test.yml)
